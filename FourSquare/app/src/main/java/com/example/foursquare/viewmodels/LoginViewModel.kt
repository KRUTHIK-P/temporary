...
class LoginViewModel : ViewModel() {
    ...
    var addReviewTextLiveData: MutableLiveData<AddFavouriteResponse?> = MutableLiveData()
    var addReviewImagesLiveData: MutableLiveData<AddFavouriteResponse?> = MutableLiveData()
    ...
    fun addReviewTextObserver(): MutableLiveData<AddFavouriteResponse?> {
        return addReviewTextLiveData
    }

    fun addReviewText(token: String, request: Map<String, String>) {
        RetrofitClient.instance.addReviewText(token, request)
            .enqueue(object : Callback<AddFavouriteResponse> {
                override fun onResponse(
                    ...
                    addReviewTextLiveData.postValue(
                        if (response.isSuccessful) {
                            response.body()
                        } else {
                            null
                ...
                override fun onFailure(call: Call<AddFavouriteResponse>, t: Throwable) {
                    addReviewTextLiveData.postValue(null)
                }
    ...
    fun addReviewImagesObserver(): MutableLiveData<AddFavouriteResponse?> {
        return addReviewImagesLiveData
    }

    fun addReviewImages(token: String, id: RequestBody, imagesList: MutableList<ImageList>) {
        RetrofitClient.instance.addReviewImages(token, id, imagesList)
            .enqueue(object : Callback<AddFavouriteResponse> {
                override fun onResponse(
                    ...
                    addReviewImagesLiveData.postValue(
                        if (response.isSuccessful) {
                            response.body()
                        } else {
                            null
                ...
                override fun onFailure(call: Call<AddFavouriteResponse>, t: Throwable) {
                    addReviewImagesLiveData.postValue(null)
                }

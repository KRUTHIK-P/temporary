...
class Filter : Fragment() {
    ...
    private fun initViewModel() {
        ...
        viewModel.getFilterSearchObserver()
            .observe(viewLifecycleOwner, Observer<GetFilterSearchResponse?> {
                ...
                if (it == null) {
                    ...
                    val sharedPreferencesManager = SharedPreferencesManager.getInstance(filterBinding.root.context)
    ...
    private fun getFilterSearch(preferences: MutableMap<String, Any>) {
        viewModel.getFilterSearch(preferences)
    }
        ...
        viewModel.getFavouritesObserver()
            .observe(viewLifecycleOwner, Observer<GetFavouritesResponse?> {
                ...
                if (it == null) {
                    ...
                    filterBinding.recyclerview.layoutManager = LinearLayoutManager(context)
                    filterBinding.recyclerview.adapter =
                        FilterSearchRecyclerViewAdapter(activity, getFilterSearchResponse, lifecycleScope, it)
                }
            })
    }
